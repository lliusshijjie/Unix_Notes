...
public:
    ...
    template <class F,
              class = typename std::enable_if<
                  !std::is_same<typename std::decay<F>::type, MyMoveOnlyFunction>::value>::type>
    MyMoveOnlyFunction(F&& f)
        : m_ptr(nullptr)
        , m_local(false) {
    ...
    MyMoveOnlyFunction(MyMoveOnlyFunction&& other) noexcept
        : m_ptr(nullptr)
        , m_local(false) {
    ...
    MyMoveOnlyFunction(const MyMoveOnlyFunction&) = delete;
    MyMoveOnlyFunction& operator=(const MyMoveOnlyFunction&) = delete;
...
private:
    ...
    void MoveFrom(MyMoveOnlyFunction&& other) noexcept {
